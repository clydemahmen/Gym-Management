    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navMenu">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php if($activePage == 'orders') echo 'active text-warning'; ?>" href="orders.php">Equipment Orders</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php if($activePage == 'ml_dashboard') echo 'active text-warning'; ?>" href="ml_dashboard.php">ML Dashboard</a>
                </li>
                <li class="nav-item">
